...
#define CAN_EXTRID_DATA_CMD		3	// Command (1st byte)
...
#define CAN_UNITID_OLICAW ((u32)(CAN_MSG_BS + 8)  << CAN_UNITID_SHIFT)	// CAW's Olimex board
#define CAN_UNITID_POD6   ((u32)(CAN_MSG_BS + 9)  << CAN_UNITID_SHIFT)	// POD board sensor prototype ("6" marked on board)
#define CAN_UNITID_OLI2   ((u32)(CAN_MSG_BS + 10)  << CAN_UNITID_SHIFT)	// POD board sensor prototype ("6" marked on board)
...
#define CAN_DATAID_LAT_LONG			CAN_TYPE_PDO1tx	// CAN_UNITID_CO_OLI Lattitude and longitude
#define CAN_DATAID_HEIGHT			CAN_TYPE_PDO2tx	// CAN_UNITID_CO_OLI Height
...
/* Extra data ID's (0 - 7) for units */
// Program loading--
#define CAN_EXTRID_DATA_RD		CAN_TYPE_SDOtx	// 11 Read data (dlc holds byte ct: 1-8)(response payload bytes 1-8: start at current address)
#define CAN_EXTRID_DATA_WR		CAN_TYPE_SDOrx	// 12 Write data dlc holds byte ct: 1-8)(
